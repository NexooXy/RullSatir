...
const isOwner = [`${owner}@s.whatsapp.net`] == sender ? true : ["6285607831410@s.whatsapp.net","6285607831410@s.whatsapp.net","6285607831410@s.whatsapp.net","6285607831410@s.whatsapp.net"].includes(sender) ? true : false
const q1 = q.split('&')[0];
const q2 = q.split('&')[1];
const q3 = q.split('&')[2];	
const q4 = q.split('&')[3];	
...
if (packagejson.description !== nyz.versi){rimurubotz.sendMessage("0@s.whatsapp.net", {text: `Cloud Bot By Rull`},{quoted:nay1})}
break
case 'xx':
reply("")
break
...
case 'donasi': 
if (cekUser("id", sender) == null) return Notdaftar()
sendMedia("image", donasi, "Donasi kak")
break
case 'daftar': case 'login':
if (cekUser("id", sender) !== null) return reply("Kamu sudah terdaftar sebelumnya")
user.push({ id: sender, emote: "🕹️", timers: moment().format('LLL'), hit: 0, star: 1, afk: false, alasan:false, ban: false, premium: false })
...
if (cekUser("id", sender) == null) return Notdaftar()
if (isMedia || isQuotedImage) { 
if (!q) return reply(`Masukkan Query Nama image, Contoh ${prefix + command} Nama`)
...
if (!q) return reply(`Masukkan Query Nama Video, Contoh ${prefix + command} Nama`)
...
if (cekUser("id", sender) == null) return Notdaftar()
if (isMedia || isQuotedSticker) { 
if (!q) return reply(`Masukkan Query Nama sticker, Contoh ${prefix + command} Nama`)
...
if (!q) return reply(`Masukkan Query Nama audio, Contoh ${prefix + command} Nama`)
...
if (cekUser("id", sender) == null) return Notdaftar()
if (!q) return reply("Masukkan nama Group nya")
